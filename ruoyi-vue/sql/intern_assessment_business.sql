...
ALTER TABLE `sys_user`
    ...
    ADD COLUMN `user_status` VARCHAR(24) NOT NULL DEFAULT 'WAIT_AUDIT' COMMENT '业务状态:NON_INTERN非实习生/WAIT_AUDIT待审核/REJECTED驳回/PRE_TRAINEE预备/FORMAL_TRAINEE正式/PENDING_PROMOTE待转正/DISABLED禁用/ARCHIVED归档' AFTER `status`,
...
-- 固定部门-岗位映射：交付、开发、设计、质检、建模部门各对应一个实习生岗位。
