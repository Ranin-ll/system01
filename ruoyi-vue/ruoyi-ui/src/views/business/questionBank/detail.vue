  ...
  <div class="bank-detail app-container">
    ...
    <template v-else>
      ...
      <section class="panel">
        <div class="panel-heading">
          <h3>知识点分布 Top 10</h3>
          <span class="hint">题量越多的知识点，越适合作为组卷的抽题范围</span>
        </div>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="680px" append-to-body>
      <el-form ref="questionForm" :model="form" :rules="rules" label-width="90px">
        ...
        <el-form-item label="知识点"><el-input v-model="form.knowledgePoint" placeholder="知识点（可选）" maxlength="64" /></el-form-item>
      </el-form>
      <span slot="footer">
